#from accelerate.test_utils.scripts.external_deps.test_ds_alst_ulysses_sp import input_ids
...
class ModelEvaluation:
        ...
        with torch.no_grad():
            for article_batch, target_batch in tqdm(zip(article_batches, target_batches),
                ...
                summaries = model.generate(input_ids=inputs['input_ids'].to(device),
                                           ...
                                           length_penalty=0.8, max_length=128)
    ...
    def evaluate(self):
        ...
        score = self.calculate_metric_on_test_ds(dataset_samsum_pt['test'][:10],
